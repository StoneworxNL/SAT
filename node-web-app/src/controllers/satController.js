...
class SatController {
    ...
    async executeSatProgram(program, inputFile, appID, branchName, diffFile, doDiff, cleanWorkingCopy, assessmentType, excludeModules, sdMicroflow, sdPrefixes, outputFile) {
        ...
        return await executeSat(program, inputFile, diffFile, doDiff, appID, branchName, cleanWorkingCopy, assessmentType, excludeModules, sdMicroflow, sdPrefixes, outputFile);
    }
